...
import {
  ...
  import { Box, VStack, Flex , Image,Text ,Button,useDisclosure , Input  } from "@chakra-ui/react";
  ...
  function Addressform({handleclick}) {
    ...
    return (
      <>
        <Button pt="0.25rem" pb="0.25rem" fontSize="14px" backgroundColor="lightgray" onClick={onOpen}>+ Add New Address</Button>             
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="3xl" isCentered>
          ...
          <ModalContent>
            <ModalHeader>
                <Flex>
                    <Box>
                        <Image w="16px" h="16px" src="https://in.sugarcosmetics.com/desc-images/Add_Address.svg" alt="" />
                    </Box>
